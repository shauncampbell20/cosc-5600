...
Plus, it doesn't need nested queries with (INTERSECT, UNION, EXCEPT, IN, NOT IN).
...
Plus, it requires nested queries with (INTERSECT, UNION, EXCEPT, IN, NOT IN).
So, we need JOIN and need nested queries, then the the SQL query can be classified as "NESTED".
Sub-questions = ["Which courses have prerequisite?"]
Label: "NESTED"
...
Sub-questions = ["Find the titles of courses that is provided by Psychology departments"]
Label: "NESTED"
...
Plus, it requires nested queries with (INTERSECT, UNION, EXCEPT, IN, NOT IN).
So, we don't need JOIN and need nested queries, then the the SQL query can be classified as "NESTED".
Sub-questions = ["Find the id of instructors who taught a class in Spring 2010"]
Label: "NESTED"
...
Plus, it requires nested queries with (INTERSECT, UNION, EXCEPT, IN, NOT IN).
So, we don't need JOIN and need nested queries, then the the SQL query can be classified as "NESTED".
Sub-questions = ["What is the average budget of the departments"]
Label: "NESTED"
